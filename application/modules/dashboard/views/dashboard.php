    ...
    <div class="row">
      <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box bg-green">
          ...
          <div class="info-box-content">
            ...
            <span class="info-box-number"><?php echo 'Rp. ' . number_format($total_day_bulan+$total_day_debit+$total_bebas_day, 0, ',', '.') ?></span>
          </div>
          <!-- /.info-box-content -->
        </div>
        <!-- /.info-box -->
      ...
      <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box bg-aqua">
          ...
          <div class="info-box-content">
            <span class="info-box-text dash-text">Penerimaan Bulan Ini</span>
            <span class="info-box-number"><?php echo 'Rp. ' . number_format($total_month_bulan+$total_month_debit+$total_bebas_month, 0, ',', '.') ?></span>
          </div>
          <!-- /.info-box-content -->
        </div>
        <!-- /.info-box -->
	 ...
	 <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box bg-yellow">
          ...
          <div class="info-box-content">
            <span class="info-box-text dash-text">Penerimaan Tahun Ini</span>
            <span class="info-box-number"><?php echo 'Rp. ' . number_format($total_year_bulan+$total_year_debit+$total_bebas_year, 0, ',', '.') ?></span>
          </div>
          <!-- /.info-box-content -->
        </div>
        <!-- /.info-box -->
	  ...
	  <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box bg-green">
          ...
          <div class="info-box-content">
            <span class="info-box-text dash-text">Seluruh Penerimaan</span>
            <span class="info-box-number"><?php echo 'Rp. ' . number_format($total_uang_bulan+$total_all_debit+$total_bebas_all, 0, ',', '.') ?></span>
          </div>
          <!-- /.info-box-content -->
        </div>
        <!-- /.info-box -->
	  ...
	  <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box bg-red">
          ...
          <div class="info-box-content">
            ...
            <span class="info-box-number"><?php echo 'Rp. ' . number_format($total_kredit_day, 0, ',', '.') ?></span>
          </div>
          <!-- /.info-box-content -->
        </div>
        <!-- /.info-box -->
	 ...
	 <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box bg-aqua">
          ...
          <div class="info-box-content">
            <span class="info-box-text dash-text">Pengeluaran Bulan Ini</span>
	  ...
	  <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box bg-yellow">
          ...
          <div class="info-box-content">
            <span class="info-box-text dash-text">Pengeluaran Tahun Ini</span>
            <span class="info-box-number"><?php echo 'Rp. ' . number_format($total_kredit_year, 0, ',', '.') ?></span>
          </div>
          <!-- /.info-box-content -->
        </div>
        <!-- /.info-box -->
        ...
        <div class="info-box bg-red">
          ...
          <div class="info-box-content">
            <span class="info-box-text dash-text">Seluruh Pengeluaran</span>
            <span class="info-box-number"><?php echo 'Rp. ' . number_format($total_kredit_all, 0, ',', '.') ?></span>
          </div>
          <!-- /.info-box-content -->
        </div>
        <!-- /.info-box -->
      ...
      <!-- /.col -->
        ...
        <div class="info-box bg-maroon">
          ...
          <div class="info-box-content">
            <span class="info-box-text dash-text">Kas Tahun Ini</span>
            <span class="info-box-number"><?php echo 'Rp. ' . number_format($total_year_bulan+$total_year_debit+$total_bebas_year-$total_kredit_year, 0, ',', '.') ?></span>
          </div>
          <!-- /.info-box-content -->
        </div>
        <!-- /.info-box -->
	  ...
	  <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box bg-purple">
          ...
          <div class="info-box-content">
            <span class="info-box-text dash-text">Total Kas</span>
            <span class="info-box-number"><?php echo 'Rp. ' . number_format($total_uang_bulan+$total_all_debit+$total_bebas_all-$total_kredit_all, 0, ',', '.') ?></span>
          </div>
          <!-- /.info-box-content -->
        </div>
        <!-- /.info-box -->
