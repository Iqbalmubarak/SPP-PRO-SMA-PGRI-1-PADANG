  ...
  <fieldset class="fieldset-auto-width">
    ...
    <div class="container">
      <div class="topright">
        ...
        <img src="<?php echo ('uploads/student/'.$student['student_img']) ?>" style="height: 50px; width: 50px; border:1px solid">
        <?php } else { ?>
        <img src="<?php echo ('media/img/missing.png') ?>" style="height: 50px; width: 50px;border:1px solid">
        <?php } ?>
      </div>
      ...
      <img style="width:142.56pt;height:18pt;z-index:6;" src="<?php echo ('media/barcode_student/'.$student['student_nis'].'.png') ?>" alt="Image_4_0" />
