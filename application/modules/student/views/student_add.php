							...
							<div class="tab-content">
								...
								<div class="tab-pane" id="tab_2">
									...
									<?php if ($setting_level['setting_value']=='senior') { ?>
										<div class="form-group">
											<label>Bidang Studi <small data-toggle="tooltip" title="Wajib diisi">*</small></label>
								...
								<div class="tab-pane" id="tab_3">
									<div class="form-group">
										...
										<input name="student_name_of_mother" type="text" class="form-control" value="<?php echo $inputMotherValue ?>" placeholder="Nama Ibu" required="">
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<input name="student_parent_phone" type="text" class="form-control" value="<?php echo $inputParPhoneValue ?>" placeholder="No Handphone Orang Tua" required="">
									</div>
