...
<body>
  ...
  <fieldset class="fieldset-auto-width">
    ...
    <div class="container">
      <div class="topright">
        <?php if (($row['student_img']) != NULL) { ?>
          <img src="<?php echo ('uploads/student/'.$row['student_img'])?>" style="height: 60px; width: 50px; border:1px solid;">
        <?php } else { ?>
          <img src="<?php echo('media/img/missing.png') ?>" style="height: 60px; width: 50px; border:1px solid;">
        <?php } ?>
      </div>
      <table class="name">
        <tr>
      ...
      <br>
      <img style="width:142.56pt;height:18pt;z-index:6;" src="<?php echo ('media/barcode_student/'.$row['student_nis'].'.png')?>" alt="Image_4_0" />
