...
class Student_model extends CI_Model {
    ...
    function get($params = array()) {
        ...
        if(isset($params['student_input_date']))
        {
            $this->db->where('student_input_date', $params['student_input_date']);
        }

        if(isset($params['student_last_update']))
        {
            $this->db->where('student_last_update', $params['student_last_update']);
        }
