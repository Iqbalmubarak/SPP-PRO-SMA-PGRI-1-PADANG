...
class Bulan_model extends CI_Model {
    ...
    function get_total($params = array())
    {
        ...
        if (isset($params['month'])) {
            $this->db->where('month(bulan_date_pay)',$params['month']);
        }

        if (isset($params['year'])) {
            $this->db->where('year(bulan_date_pay)',$params['year']);
        }
...
function delete_month($params = array ()) {
    if (isset($params['payment_id'])) {
...
function delete_bulan($params = array ()) {
    if (isset($params['payment_id'])) {
        $this->db->where('payment_payment_id', $params['payment_id']);
    }
    if(isset($params['student_id'])){
