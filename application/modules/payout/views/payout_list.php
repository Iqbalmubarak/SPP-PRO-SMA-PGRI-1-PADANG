		...
		<div class="row">
			...
			<?php if ($f) { ?>
				...
				<div class="box box-success">
					...
					<div class="col-md-6">
						<div class="box box-primary">
							<div class="box-header with-border">
								...
								<!-- project ichsan print tagihan per item -->
								<!-- copy dari student list -->
								<div> 
								
									<form action="<?php echo site_url('manage/payout/cetakBuktiPerItem') ?>" method="GET" class="view-pdf">
										...
										<div class="box-body">
											<table class="table table-responsive table-bordered" style="white-space: nowrap;">
												<tr class="info">
													<th><input type="checkbox" id="selectall" value="c" name="c"></th>
													<th>Pembayaran</th>
													<th>Tagihan</th>
													<th>Tanggal</th>
												</tr>
												...
												foreach ($log as $key) :
												?>
												<input type="hidden" name="v" value="<?php echo $i ?>">
												<tr>
													<td><input type="checkbox" class="checkbox" name="c[<?php echo $i; ?>]" value="<?php echo $key['log_trx_id']; ?>"></td>
					...
					<!-- sementara Cetak Bukti Pembayaran hanya bisa Per Tanggal -->
					<div class="col-md-3">
						<div class="box box-primary">
							<div class="box-header with-border">
				...
				<div class="box box-primary">
					<div class="box-header with-border">
						<h3 class="box-title">List Tagihan Siswa</h3>
					</div><!-- /.box-header -->
					<div class="box-body">
					<a href="" class="btn btn-info btn-xs"><i class="fa fa-refresh" text-align="center"></i> Refresh</a>
						<div class="nav-tabs-custom">
							<!--<ul class="nav nav-tabs">
								<li class="active"><a href="#tab_1" data-toggle="tab">Rincian Tagihan Siswa</a></li>
							</ul> -->
							<ul>
