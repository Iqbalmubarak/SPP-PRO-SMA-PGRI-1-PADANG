...
<body>
		...
		<tbody>
			<tr>
                ...
                <?php foreach ($log as $row): ?>
                    <td style="width: 150px;"><?php echo pretty_date($row['log_trx_input_date'],'d F Y',false)?></td>
				<?php endforeach ?>
			</tr>
			<tr>
	...
	<table  style="border-style: solid;">
		...
		<tr>
			...
			<td style="background-color: #; font-weight:;border-bottom: 1px solid; text-align: right;"><?php echo number_format($sum_m+$sum_b, 0, ',', '.') ?> &nbsp;</td>
		</tr>
		<tr>
		<br>
		</br>
