		...
		<div class="row"> 
			<div class="col-xs-12"> 
				<div class="box box-primary">
					...
					<div class="col-sm-10">
						<a class="btn btn-primary btn-sm" href="<?php echo site_url('manage/payment/add_payment_bebas/' . $payment['payment_id']) ?>"><span class="glyphicon glyphicon-plus"></span>Tagihan Per Kelas</a>
						<?php if(majors() == 'senior') { ?>
							<a class="btn btn-warning btn-sm" href="<?php echo site_url('manage/payment/add_payment_bebas_majors/' . $payment['payment_id']) ?>"><span class="glyphicon glyphicon-plus"></span> Tagihan Per Bidang Studi</a>
						<?php } ?>
						<a class="btn btn-info btn-sm" href="<?php echo site_url('manage/payment/add_payment_bebas_student/' . $payment['payment_id']) ?>"><span class="glyphicon glyphicon-plus"></span> Tagihan Per Siswa</a>
