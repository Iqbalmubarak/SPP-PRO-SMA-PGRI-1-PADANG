*/ location : \application\modules\payment\views\payment_view_bulan.php */
				...
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<div class="form-group">						
							...
							<label for="" class="col-sm-2 control-label">Bidang Studi</label>
							<div class="col-sm-2">
					...
					<hr>
					<label for="" class="col-sm-2">BUAT TAGIHAN SISWA</label>
					<div class="col-sm-10">
						<a class="btn btn-primary btn-sm" href="<?php echo site_url('manage/payment/add_payment_bulan/' . $payment['payment_id']) ?>"><span class="glyphicon glyphicon-plus"></span> Tagihan Per Kelas</a>
						<?php if (majors() == 'senior') { ?>
						<a class="btn btn-warning btn-sm" href="<?php echo site_url('manage/payment/add_payment_bulan_majors/' . $payment['payment_id']) ?>"><span class="glyphicon glyphicon-plus"></span> Tagihan Per Bidang Studi</a>
						<?php } ?>
						<a class="btn btn-info btn-sm" href="<?php echo site_url('manage/payment/add_payment_bulan_student/' . $payment['payment_id']) ?>"><span class="glyphicon glyphicon-plus"></span> Tagihan Per Siswa</a>
						...
						<tbody>
							...
							foreach ($student as $row):
								...
								<td>
										...
										<a href="<?php echo site_url('manage/payment/delete_payment_bula/'. $row['payment_payment_id'].'/'.$row['student_student_id']) ?>" class="btn btn-xs btn-danger" data-toggle="tooltip" title="Hapus Data"><i class="fa fa-eraser"></i></a>											
									</td>
								</tr>
								<?php
								$i++;
