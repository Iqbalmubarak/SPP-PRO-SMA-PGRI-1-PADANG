...
class Log_trx_model extends CI_Model {
    ...
    function get($params = array()) {
        ...
        if (isset($params['multiple_id'])) {
            $this->db->where_in('log_trx.log_trx_id', $params['multiple_id']);
        }
        ...
        $this->db->select('bulan_bulan_id, log_trx.student_student_id, student_nis, bulan_bill, month_name, bebas_pay_bill,month_id');
        ...
        $this->db->select('periodBebas.period_start AS period_start_bebas, periodBebas.period_end AS period_end_bebas, bebas_pay_desc, bebas_bill');
